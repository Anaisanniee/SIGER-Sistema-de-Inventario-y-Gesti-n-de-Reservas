...
<body>
    ...
    <div class="siger-contenedor-login">
        <div class="tarjeta-recuperacion tarjeta-blanca-datos">
            ...
            <main>
                {{-- APUNTAMOS A LA RUTA NATIVA DE LARAVEL QUE CREAMOS EN WEB.PHP --}}
                <form action="{{ route('password.email') }}" method="POST" class="grid-campos-perfil-login">
                    @csrf 
                    ...
                    <div class="botones-accion-final full-width-campo">
                        <x-botones.boton url="{{ route('login') }}" clase="btn-rojo text-center-link">
                            Volver al Login
                        </x-botones.boton>
