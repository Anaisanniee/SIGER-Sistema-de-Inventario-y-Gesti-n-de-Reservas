    ...
    <div class="collapse dont-collapse-md" id="formularioColapsable">
        <form class="form-registrar" action="{{ route('usuarios.store') }}" method="POST">
            ...
            <div class="post-form">
                ...
                <input type="text" id="identificacion" name="document_id" required> {{-- Corregido 'documento' por 'document_id' para que coincida con el controlador --}}
            </div>

            <div class="post-form">
                <label for="correo">Correo</label>
                <input type="email" id="correo" name="email"> {{-- Corregido 'mail' por 'email' --}}
            </div>
