...
<div class="container-fluid px-4">
    ...
    <div class="row g-3 mb-4 align-items-center">
        <div class="col-auto">
            <button class="btn btn-light border fw-bold rounded-3 px-3 py-2 text-secondary shadow-sm" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFiltros" aria-expanded="false" aria-controls="collapseFiltros">
                🔑 Filtros
            </button>
        </div>
        <div class="col">
            <form action="{{ route('inventario.prestamos') }}" method="GET" class="position-relative">
